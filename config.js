...
var SALES_CONFIG = {
    ...
    ACCOUNTS: {
        ...
        REVENUE: '4010', // إيرادات المبيعات
        COGS: '5010', // تكلفة البضاعة المباعة
        INVENTORY: '1030', // المخزون
        DISCOUNT: '4030', // خصومات المبيعات
        RETURNS: '4040', // مردودات المبيعات
        SHIPPING: '5080', // مصاريف الشحن
...
var PURCHASE_CONFIG = {
    ...
    ACCOUNTS: {
        ...
        PURCHASE_EXPENSE: '5010', // مصاريف المشتريات
        FREIGHT_IN: '5080', // مصاريف النقل للمشتريات
...
if (typeof window !== 'undefined') {
    ...
    console.log('تم تحميل ملف الإعدادات config.js بنجاح');
}
...
function initializeSystemDefaults() {
    try {
        ...
        if (!COMPANY_INFO.BASIC.name || COMPANY_INFO.BASIC.name === 'اسم الشركة أو المحل') {
            console.warn('يرجى تحديث معلومات الشركة في ملف config.js');
        }
        ...
        console.error('خطأ في تهيئة النظام core:', error);
        return false;
    }
}
